...
CONFIG_FILE_NAME=application.properties bash -x $BASE_DIR/utils/create-cm.sh quarkus-application-config $BASE_DIR/app/src/main/resources/prod-application.properties
